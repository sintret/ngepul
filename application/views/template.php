...
<div id="wrapper">
		...
		<div id="nav">
				<div id="nav-title">
					<h3><strong>Hi</strong>, thinkloud</h3>
				</div>
				<!-- //nav-title-->
				<div id="nav-scroll">
								...
								<ul>
										<li>
												<section  class="thumbnail-in">
														...
														<div class="im-thumbnail"><img alt="" src="<?= base_url() ?>assets/img/avatar2.png" /></div>
														<label></label>
										...
										<li>
												<section class="thumbnail-in">
														...
														<div class="im-thumbnail"><img alt="" src="<?= base_url() ?>assets/img/avatar.png" /></div>
		...
		<nav id="menu"  data-search="close">
				<ul>
						...
						<li class="activelink"><a href="<?= base_url() ?>dashboard"><i class="icon  fa fa-th"></i> Dashboard </a></li>
						<!--
						...
						<li><a href="lockscreen.php"><i class="icon  fa fa-sitemap"></i>LockScreen</a></li>
						-->
				</ul>
		</nav>
		<!-- //nav left menu-->
				...
				<ul>
						...
						<li data-counter-color="theme">
								...
								<ul>
										...
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/1.jpg" /> Alexa 
														<small>Johnson</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/2.jpg" /> Alexander 
														<small>Brown</small>
												</a>
										</li>
										<li class="Label">F</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?><?= base_url() ?>assets/photos_preview/50/people/3.jpg" /> Fred
														<small>Smith</small>
												</a>
										</li>
										<li class="Label">J</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/4.jpg" /> James
														<small>Miller</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/5.jpg" /> Jefferson
														<small>Jackson</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/6.jpg" /> Jordan
														<small>Lee</small>
												</a>
										</li>
										<li class="Label">K</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/7.jpg" /> Kim
														<small>Adams</small>
												</a>
										</li>
										<li class="Label">M</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/8.jpg" /> Meagan
														<small>Miller</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/9.jpg" /> Melissa
														<small>Johnson</small>
												</a>
										</li>
										<li class="Label">N</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/10.jpg" /> Nicole
														<small>Smith</small>
												</a>
										</li>
										<li class="Label">S</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/1.jpg" /> Samantha
														<small>Harris</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="block">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/2.jpg" /> Scott
						...
						<li>
								...
								<ul>
										...
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/3.jpg" /> Adam
														<small>White</small>
												</a>
										</li>
										<li class="Label">B</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/4.jpg" /> Ben
														<small>Robinson</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/5.jpg" /> Bruce
														<small>Lee</small>
												</a>
										</li>
										<li class="Label">E</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/6.jpg" /> Eddie
										...
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/7.jpg" /> Jack
														<small>Johnson</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/8.jpg" /> John
														<small>Jackman</small>
												</a>
										</li>
										<li class="Label">M</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/9.jpg" /> Martina
														<small>Thompson</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/10.jpg" /> Matthew
														<small>Watson</small>
												</a>
										</li>
										<li class="Label">O</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/1.jpg" /> Olivia
														<small>Taylor</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/2.jpg" /> Owen
														<small>Wilson</small>
												</a>
										</li>
								</ul>
						...
						<li data-counter-color="theme-inverse">
								...
								<ul>
										...
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/3.jpg" /> David
														<small>Harris</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/4.jpg" /> Dennis
														<small>King</small>
												</a>
										</li>
										<li class="Label">E</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/5.jpg" /> Eliza
														<small>Walker</small>
												</a>
										</li>
										<li class="Label">L</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/6.jpg" /> Larry
														<small>Turner</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/7.jpg" /> Lisa<br />
														<small>Wilson</small>
												</a>
										</li>
										<li class="Label">M</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/8.jpg" /> Michael
														<small>Jordan</small>
												</a>
										</li>
										<li class="Label">R</li>
										<li class="img">
												<a href="#">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/9.jpg" /> Rachelle
														<small>Cooper</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/10.jpg" /> Rick
														<small>James</small>
												</a>
										</li>
								</ul>
						...
						<li class="img">
								<a href="#" class="online">
										<img alt="" src="<?= base_url() ?>assets/photos_preview/50/people/5.jpg" /> Samantha
										<small>Harris</small>
								</a>
						</li>
